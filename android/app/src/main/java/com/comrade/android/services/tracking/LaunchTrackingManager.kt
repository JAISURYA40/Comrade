...
import com.comrade.android.receivers.AccessibilityReceiver
import com.comrade.android.receivers.DeviceLockUnlockReceiver
...
class LaunchTrackingManager(
    ...
    companion object {
        private const val TAG = "Comrade.LaunchTrackingManager"
    ...
    private fun onDeviceUnlocked() {
        ...
        isManualTrackingOn =
            !Utils.isServiceRunning(context, ComradeAccessibilityService::class.java)
