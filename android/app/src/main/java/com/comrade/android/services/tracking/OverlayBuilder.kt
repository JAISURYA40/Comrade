...
import com.comrade.android.enums.RestrictionType
...
import com.comrade.android.utils.ComradeQuotes
...
object OverlayBuilder {
    ...
    fun buildToastOverlay(
        ...
        toastView.setOnClickListener {
            ...
            context.applicationContext.startActivity(
                AppUtils.getIntentForComradeUri(
                    context,
    ...
    fun buildFullScreenOverlay(
        ...
        val randomQuote = ComradeQuotes.getRandomQuote()
