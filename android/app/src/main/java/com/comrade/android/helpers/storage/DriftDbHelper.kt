package com.comrade.android.helpers.storage
...
object DriftDbHelper {
    private const val TAG = "Comrade.DriftDbHelper"

    // Open the database if it's not already open
    private fun openDatabase(context: Context): SQLiteDatabase? {
        try {
            // /data/user/0/com.comrade.android/app_flutter/Comrade0.sqlite
            val dbPath = "${context.dataDir.path}/app_flutter/Comrade.sqlite"
