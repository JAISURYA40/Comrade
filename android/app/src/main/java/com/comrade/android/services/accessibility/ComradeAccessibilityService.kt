 ...
 *
 */
package com.comrade.android.services.accessibility
...
import com.comrade.android.AppConstants.FACEBOOK_PACKAGE
import com.comrade.android.AppConstants.INSTAGRAM_PACKAGE
import com.comrade.android.AppConstants.REDDIT_PACKAGE
import com.comrade.android.AppConstants.SETTINGS_PACKAGE
import com.comrade.android.AppConstants.SNAPCHAT_PACKAGE
import com.comrade.android.AppConstants.YOUTUBE_PACKAGE
import com.comrade.android.R
import com.comrade.android.enums.PlatformFeatures
import com.comrade.android.helpers.device.PermissionsHelper
import com.comrade.android.helpers.storage.SharedPrefsHelper
import com.comrade.android.models.Wellbeing
import com.comrade.android.receivers.DeviceAppsChangedReceiver
import com.comrade.android.utils.ThreadUtils
import com.comrade.android.utils.executors.Throttler
 ...
 */
class ComradeAccessibilityService : AccessibilityService(), OnSharedPreferenceChangeListener {
    companion object {
        private const val TAG = "Comrade.ComradeAccessibilityService"

        const val ACTION_PERFORM_HOME_PRESS = "com.comrade.android.action.performHomePress"
        const val ACTION_MIDNIGHT_ACCESSIBILITY_RESET =
            "com.comrade.android.action.midnightAccessibilityReset"
        const val ACTION_TAMPER_PROTECTION_CHANGED =
            "com.comrade.android.action.tamperProtectionChanged"
    ...
    private fun goBackWithToast(customAction: Int? = null) {
        throttler.submit {
            ThreadUtils.runOnMainThread {
                ...
                Toast.makeText(
                    this@ComradeAccessibilityService,
