...
import com.comrade.android.helpers.usages.NetworkUsageHelper
import com.comrade.android.helpers.usages.ScreenUsageHelper
...
class AggregatedUsageWidgetProvider : AppWidgetProvider() {
    companion object {
        private const val TAG = "Comrade.AggregatedUsageWidgetProvider"
        private const val ACTION_REFRESH_WIDGET =
            "com.comrade.android.action.refreshAggregatedUsageWidgetProvider"
    }
    ...
    private fun setUpClickListener(context: Context, views: RemoteViews) {
        val launchPendingIntent = AppUtils.getPendingIntentForComradeUri(
            context,
            "com.comrade.android://open/home?tab=1"
        )
