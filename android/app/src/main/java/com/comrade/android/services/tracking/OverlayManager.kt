package com.comrade.android.services.tracking
...
import com.comrade.android.helpers.device.NotificationHelper.USAGE_REMINDERS_CHANNEL_ID
import com.comrade.android.helpers.storage.SharedPrefsHelper
import com.comrade.android.models.RestrictionState
import com.comrade.android.services.accessibility.ComradeAccessibilityService
import com.comrade.android.services.accessibility.ComradeAccessibilityService.Companion.ACTION_PERFORM_HOME_PRESS
import com.comrade.android.services.tracking.OverlayBuilder.getAppLabelAndIcon
...
class OverlayManager(
            ...
            NotificationCompat.Builder(
                ...
                .setContentIntent(
                    AppUtils.getPendingIntentForComradeUri(
                        context,
                        "com.comrade.android://open/appDashboard?package=$packageName"
                    )
                )
                .build()
        )
    ...
    companion object {
        private const val TAG = "Comrade.OverlayManager"
