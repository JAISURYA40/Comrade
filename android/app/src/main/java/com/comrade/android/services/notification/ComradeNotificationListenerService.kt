 ...
 *
 */
package com.comrade.android.services.notification
...
import com.comrade.android.generics.SmartCacheBox
import com.comrade.android.helpers.storage.DriftDbHelper
...
class ComradeNotificationListenerService : NotificationListenerService() {
    companion object {
        private const val TAG = "Comrade.ComradeNotificationService"
    }

    private val binder = ServiceBinder(this@ComradeNotificationListenerService)
    ...
    override fun onListenerDisconnected() {
        ...
        // Try to rebind again
        runCatching {
            val listener = ComponentName(this, ComradeNotificationListenerService::class.java)
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        try {
            // If from comrade or not clearable or group summery
            val isGroupSummary =
    ...
    override fun onBind(intent: Intent): IBinder? {
        return if (intent.action == ServiceBinder.ACTION_BIND_TO_COMRADE) binder
