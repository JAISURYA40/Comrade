...
class ScreenUsageWidgetProvider : AppWidgetProvider() {
    companion object {
        private const val TAG = "Comrade.ScreenUsageWidgetProvider"
        private const val ACTION_REFRESH_WIDGET = "com.comrade.android.action.refreshScreenUsageWidgetProvider"
    }
