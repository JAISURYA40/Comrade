 ...
 *
 */
package com.comrade.android.generics
...
class ServiceBinder<T : Service?>(val service: T) : Binder() {
    companion object {
        const val ACTION_START_COMRADE_SERVICE: String =
            "com.comrade.android.action.startComradeService"

        const val ACTION_BIND_TO_COMRADE: String =
            "com.comrade.android.action.bindToComrade"
    }
}
