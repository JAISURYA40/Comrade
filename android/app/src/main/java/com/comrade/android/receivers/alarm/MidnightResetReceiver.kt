...
import com.comrade.android.helpers.AlarmTasksSchedulingHelper.scheduleMidnightResetTask
...
import com.comrade.android.services.accessibility.ComradeAccessibilityService.Companion.ACTION_MIDNIGHT_ACCESSIBILITY_RESET
import com.comrade.android.services.tracking.ComradeTrackerService
import com.comrade.android.utils.Utils
import com.comrade.android.workers.FlutterBgExecutionWorker
import com.comrade.android.workers.FlutterBgExecutionWorker.Companion.FLUTTER_TASK_ID

class MidnightResetReceiver : BroadcastReceiver() {
    companion object {
        private const val TAG = "Comrade.MidnightResetReceiver"
        const val ACTION_START_MIDNIGHT_RESET = "com.comrade.android.action.startMidnightReset"
    }
        ...
        if (intent.action == ACTION_START_MIDNIGHT_RESET) {
            WorkManager.getInstance(context).let {
                ...
                it.enqueueUniqueWork(
                    "Comrade.MidnightResetReceiver.Native",
                ...
                it.enqueueUniqueWork(
                    "Comrade.MidnightResetReceiver.FlutterBg",
                    ExistingWorkPolicy.KEEP,
                    OneTimeWorkRequest
    ...
    class MidnightResetWorker(
        ...
        override fun doWork(): Result {
            try {
                ...
                mTrackerServiceConn.setOnConnectedCallback { service: ComradeTrackerService -> service.onMidnightReset() }
