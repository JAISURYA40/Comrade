...
import com.comrade.android.MainActivity
...
import com.comrade.android.receivers.DeviceAdminReceiver
...
object NewActivitiesLaunchHelper {
    private const val TAG = "Comrade.ActivityNewTaskHelper"
    ...
    // SECTION: For COMRADE app ====================================================================
    /**
     * Gracefully close and restart the app.
     *
     * @param activity The activity to use.
     */
    fun restartComrade(activity: Activity) {
        ...
        Toast.makeText(activity, "Comrade is restarting", Toast.LENGTH_LONG).show()
    ...
    /**
     * Opens the comrade's notification settings for permission.
     *
     * @param context The context to use for launching the activity.
     */
    fun openComradeNotificationSection(context: Context) {
