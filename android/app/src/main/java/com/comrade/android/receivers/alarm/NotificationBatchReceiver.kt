...
class NotificationBatchReceiver : BroadcastReceiver() {
    companion object {
        private const val TAG = "Comrade.NotificationBatchReceiver"
        const val ACTION_PUSH_BATCH: String = "com.comrade.android.action.PushBatch"
        const val EXTRA_NOTIFICATION_SETTINGS_JSON =
            "com.comrade.android.extra.notificationSettingsJson"
    }
    ...
    class NotificationBatchWorker(
        ...
        private fun pushSummeryNotification(unreadNotificationsCount: Int) {
            ...
            val comradePendingIntent = AppUtils.getPendingIntentForComradeUri(
                context,
                "com.comrade.android://open/notifications"
            )
            ...
            val notification = NotificationCompat.Builder(
                ...
                .setContentIntent(comradePendingIntent)
                .setContentText(msg)
        ...
        private fun pushAllUnreadNotifications(notifications: List<Notification>) {
            try {
                ...
                val comradeIntent = AppUtils.getPendingIntentForComradeUri(
                    context,
                    "com.comrade.android://open/notifications"
                )
