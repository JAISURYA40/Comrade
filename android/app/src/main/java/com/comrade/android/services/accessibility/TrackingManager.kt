...
import com.comrade.android.AppConstants.SYSTEM_UI_PACKAGE
...
class TrackingManager(
    ...
    companion object {
        const val ACTION_ACCESSIBILITY_ACTIVE = "com.comrade.android.action.accessibilityActive"
        const val ACTION_ACCESSIBILITY_INACTIVE = "com.comrade.android.action.accessibilityInactive"
        const val ACTION_NEW_APP_LAUNCHED = "com.comrade.android.action.newAppLaunched"
        const val EXTRA_PACKAGE_NAME: String = "com.comrade.android.extra.packageName"
    }
    ...
    private fun broadcastEvent(action: String, extraPackage: String? = null) {
        try {
            ...
            Log.e(
                "Comrade.Accessibility.TrackingManager",
