...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get comrade_tagline => 'Concéntrate en lo que realmente Importa';
  ...
  String get permission_sheet_privacy_info =>
      'Comrade es 100% seguro y funciona sin conexión. No recopilamos ni almacenamos datos personales.';
  ...
  String get permission_grant_step_two =>
      '2. Seleccione Comrade en la siguiente pantalla.';
  ...
  String get permission_alarms_info =>
      'Por favor, concede permisos para configurar alarmas y recordatorios. Esto permitirá que Comrade inicie tu horario de sueño a tiempo, reinicie los temporizadores de la aplicación diariamente a medianoche y te ayude a mantener el control.';
  ...
  String get permission_usage_info =>
      'Por favor, concede permiso de acceso de uso. Esto permitirá a Comrade monitorizar el uso de aplicaciones y gestionar el acceso a ciertas apps, asegurando un entorno digital más enfocado y controlado.';
  ...
  String get permission_overlay_info =>
      'Por favor, concede el permiso de superposición de pantalla. Esto permitirá a Comrade mostrar una superposición cuando se abra una aplicación en pausa, ayudándote a mantenerte centrado y así mantener su horario.';
  ...
  String get permission_accessibility_info =>
      'Por favor, concede el permiso de accesibilidad. Esto permitirá a Comrade restringir el acceso al contenido de \"vídeo corto\" (P. ej., Reels, Shorts) dentro de las apps de redes sociales y los navegadores, y filtrar sitios web inapropiados.';

  @override
  String get permission_accessibility_required =>
      'Comrade requiere permiso de accesibilidad para bloquear de forma efectiva el contenido corto y los sitios web.';
  ...
  String get permission_dnd_info =>
      'Por favor, concede acceso a No molestar. Esto permitirá a Comrade iniciar y detener el modo No molestar durante el horario de sueño.';
  ...
  String get permission_vpn_info =>
      'Por favor, concede el permiso para crear una conexión de Red Privada Virtual (VPN). Esto permitirá a Comrade restringir el acceso a internet para las aplicaciones designadas creando una VPN local en el dispositivo.';
  ...
  String get permission_notification_access_info =>
      'Por favor, concede el permiso de acceso a notificaciones. Esto permitirá a Comrade organizar tus notificaciones y entregarlas según tu horario.';

  @override
  String get permission_notification_access_required =>
      'Comrade requiere acceso a notificaciones para agrupar y programar las mismas.';
  ...
  String get development_dialog_info =>
      'Comrade se encuentra actualmente en desarrollo y puede contener errores funciones incompletas. Si encuentras algún problema, por favor, infórmanos para ayudarnos a mejorar.\n\n¡Gracias por tus comentarios!';
  ...
  String get donation_card_info =>
      'Comrade es gratuito y de código abierto, desarrollado con meses de dedicación. Si te ha sido útil, tu donación significaría muchísimo para nosotros. Cada contribución nos ayuda a seguir mejorando y manteniéndolo para todos.';
  ...
  String get app_restart_dialog_info =>
      'Comrade se reiniciará automáticamente una vez que termine la cuenta regresiva. Por favor, ten paciencia mientras se aplican los cambios.';

  @override
  String get accessibility_tip =>
      '¿Quieres un bloqueo más inteligente y que gaste menos batería? Habilita el permiso de Accesibilidad para Comrade.';

  @override
  String get battery_optimization_tip =>
      '¿Comrade no funciona? Permite \'Ignorar la optimización de la batería\' en los Ajustes para que siga funcionando sin problemas.';
  ...
  String get tamper_protection_tip =>
      '¿Estas desinstalando Comrade? Habilita la Ventana de Desinstalación para desactivar la protección contra manipulaciones de forma segura primero.';
  ...
  String get onboarding_page_one_info =>
      'Pausa las apps que te distraen, bloquea el contenido corto y mantente centrado con sesiones de enfoque personalizables. Ya sea que estés trabajando, estudiando o relajándote, Comrade te ayuda a mantener el control.';
  ...
  String get onboarding_page_three_info =>
      'Comrade es 100% de código abierto y funciona completamente sin conexión. No recopilamos ni compartimos tus datos personales; tu privacidad está garantizada de todas las maneras.';
  ...
  String get onboarding_page_permissions_info =>
      'Comrade requiere los siguientes permisos esenciales para monitorizar y gestionar tu tiempo de pantalla, ayudando a reducir las distracciones y mejorando el enfoque.';
  ...
  String get protected_access_tile_subtitle =>
      'Protege Comrade con el desbloqueo de tu dispositivo.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'Una vez habilitado, no podrás desinstalar, forzar detención o borrar los datos de Comrade, excepto durante la ventana de desinstalación seleccionada. No hay soluciones alternativas.\n\nProcede bajo tu propio riesgo.';
  ...
  String get service_stopping_warning =>
      'Si Comrade deja de funcionar inesperadamente, por favor, concede el permiso \"Ignorar Optimización de Batería\" para mantenerlo funcionando en segundo plano. Si el problema persiste, intenta añadir Comrade a la lista blanca para un rendimiento ininterrumpido.';

  @override
  String get whitelist_app_tile_title => 'Añadir Comrade a la lista blanca';

  @override
  String get whitelist_app_tile_subtitle =>
      'Permitir que Comrade inicie automáticamente.';
