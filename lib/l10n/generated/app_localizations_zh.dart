...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get comrade_tagline => '聚焦重要的事';
  ...
  String get permission_sheet_privacy_info =>
      'Comrade 安全且不使用互联网。我们不收集或存储任何个人数据。';
  ...
  @override
  String get permission_grant_step_two => '2. 请在下一个屏幕中选择 Comrade。';
  ...
  String get permission_usage_info =>
      '请授予使用访问权限。这将允许Comrade监控应用使用情况并管理对某些应用的访问，确保更专注和受控的数字环境。';
  ...
  String get permission_overlay_info =>
      '请授予显示叠加层权限。这将允许Comrade在暂停的应用打开时显示叠加层，帮助您保持专注并维持您的日程安排。';
  ...
  String get permission_accessibility_info =>
      '请授予无障碍权限。这将允许Comrade限制社交媒体应用和浏览器中的短视频内容（例如Reels、Shorts）访问，并过滤不当网站。';

  @override
  String get permission_accessibility_required => 'Comrade需要无障碍权限才能有效阻止短内容和网站。';

  @override
  String get permission_accessibility_device_tile_label => '使用Comrade';
  ...
  String get permission_dnd_info =>
      '请授予请勿打扰访问权限。这将允许Comrade在睡眠时间表期间开始和停止请勿打扰模式。';
  ...
  String get permission_vpn_info =>
      '请授予创建虚拟专用网络（VPN）连接的权限。这将使Comrade能够通过在设备上创建本地VPN来限制指定应用程序的互联网访问。';
  ...
  String get permission_notification_access_info =>
      '请授予通知访问权限。这将允许Comrade组织您的通知并按照您的日程安排进行交付。';

  @override
  String get permission_notification_access_required =>
      'Comrade需要通知访问权限来批量和安排通知。';
  ...
  String get development_dialog_info =>
      'Comrade 目前处于开发阶段，可能存在漏洞或不完整的功能。如果您遇到任何问题，请报告以帮助我们改进。\n\n感谢您的反馈！';
  ...
  String get donation_card_info =>
      'Comrade 是免费且开源的，经过数月的奉献开发。如果它对您有帮助，您的捐款将对我们意义重大。每一份贡献都帮助我们继续改进和维护它，以造福所有人。';
  ...
  @override
  String get app_restart_dialog_info => 'Comrade 将在倒计时结束后自动重启。请耐心等待，应用正在应用更改。';

  @override
  String get accessibility_tip => '需要更智能，更省电的拦截吗？为Comrade启动无障碍权限。';

  @override
  String get battery_optimization_tip =>
      'Comrade无法运行？在设置中启用“忽略电池优化”以便可以更流畅的运行。';
  ...
  @override
  String get tamper_protection_tip => '正在卸载 Comrade？请先启用卸载窗口以安全地禁用防篡改保护。';
  ...
  String get onboarding_page_one_info =>
      '暂停分散注意力的应用，屏蔽短内容，并通过可定制的专注会话保持在正轨上。不论你是在工作、学习或放松，Comrade都能帮助你保持控制。';
  ...
  String get onboarding_page_three_info =>
      'Comrade 是 100% 开源的，并且完全离线运行。我们不收集或分享您的个人数据——您的隐私在每个方面都得到保证。';
  ...
  String get onboarding_page_permissions_info =>
      'Comrade 需要以下必要权限来跟踪和管理您的屏幕时间，帮助减少干扰并提高专注度。';
  ...
  @override
  String get protected_access_tile_subtitle => '使用设备锁保护Comrade。';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      '一旦启用，您将无法卸载、强制停止或清除 Comrade 的数据，除非在指定的卸载时间段内。没有其他例外。\n\n请自行承担风险。';
  ...
  String get service_stopping_warning =>
      '如果 Comrade 意外停止工作，请授予“忽略电池优化”权限以保持后台运行。如果问题持续，请将 Comrade 加入白名单以获得无间断性能。';

  @override
  String get whitelist_app_tile_title => '将 Comrade 加入白名单';

  @override
  String get whitelist_app_tile_subtitle => '允许 Comrade 自动启动。';
  ...
  String get privacy_policy_info =>
      'Comrade 致力于保护您的隐私。我们不收集、存储或传输任何类型的用户数据。该应用完全离线运行，不需要互联网连接，确保您的个人信息在您的设备上保持私密和安全。作为免费开源软件 (FOSS) 应用，Comrade 保证对用户数据的完全透明度和用户控制。';
