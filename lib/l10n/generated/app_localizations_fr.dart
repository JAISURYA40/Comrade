...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get comrade_tagline => 'Concentrez-vous sur ce qui compte vraiment';
  ...
  String get permission_sheet_privacy_info =>
      'Comrade est 100% sécurisé et fonctionne hors ligne. Nous ne collectons ni stockons aucune donnée personnelle.';
  ...
  String get permission_grant_step_two =>
      '2. Sélectionnez Comrade sur l\'écran suivant.';
  ...
  String get permission_alarms_info =>
      'Veuillez accorder la permission de régler les alarmes et les rappels. Cela permettra à Comrade de démarrer votre horaire de coucher à l\'heure, de réinitialiser les minuteurs de l\'application tous les jours à minuit et de vous aider à rester sur la bonne voie.';
  ...
  String get permission_usage_info =>
      'Veuillez accorder l\'autorisation d\'accès aux données d\'utilisation. Cela permettra à Comrade de surveiller l\'utilisation des applications et de gérer l\'accès à certaines applications, pour un environnement numérique plus contrôlé et propice à la concentration.';
  ...
  String get permission_overlay_info =>
      'Veuillez accorder la permission d\'afficher la superposition. Cela permettra à Comrade d\'afficher une surcouche quand une application en pause est ouverte, ce qui vous aidera à rester concentré et à maintenir votre planning.';
  ...
  String get permission_accessibility_info =>
      'Veuillez accorder l\'autorisation d\'accessibilité. Cela permettra à Comrade de restreindre l\'accès au contenu vidéo court (ex : Reels, Shorts) dans les applications de réseaux sociaux et les navigateurs, et filtrer les sites Web inappropriés.';

  @override
  String get permission_accessibility_required =>
      'Comrade a besoin des permissions d\'accessibilité pour mieux bloquer les sites internet et les formats courts.';

  @override
  String get permission_accessibility_device_tile_label => 'Utiliser Comrade';
  ...
  String get permission_dnd_info =>
      'Veuillez autoriser l\'accès au mode Ne pas déranger. Cela permettra à Comrade de démarrer et d\'arrêter le mode Ne pas déranger pendant l\'horaire du sommeil.';
  ...
  String get permission_vpn_info =>
      'Veuillez accorder la permission de créer une connexion au réseau privé virtuel (VPN). Cela permettra à Comrade de restreindre l\'accès à Internet pour les applications désignées en créant un VPN local sur le périphérique.';
  ...
  String get permission_notification_access_info =>
      'Veuillez accorder l\'autorisation d\'accès aux notifications. Cela permettra à Comrade d\'organiser vos notifications et de les envoyer selon votre planning.';

  @override
  String get permission_notification_access_required =>
      'Comrade nécessite un accès aux notifications pour regrouper et planifier les notifications.';
  ...
  String get development_dialog_info =>
      'Comrade est actuellement en cours de développement et peut avoir des bugs ou des fonctionnalités incomplètes. Si vous rencontrez des problèmes, merci de les signaler pour nous aider à nous améliorer.\n\nMerci pour vos retours !';
  ...
  String get donation_card_info =>
      'Comrade est une application gratuite et open-source, développée avec dévouement durant des mois. Si elle vous a aidé, votre don signifierait beaucoup pour nous. Chaque don nous permet de continuer à l\'améliorer et la maintenir pour tous.';
  ...
  String get app_restart_dialog_info =>
      'Comrade redémarrera automatiquement à la fin du compte à rebours. Merci de patienter le temps que les modifications soient appliquées.';
  ...
  String get onboarding_page_one_info =>
      'Que vous travailliez, étudiiez, ou que vous reposiez, Comrade met en pause les distractions et vous permet de garder le contrôle avec des sessions de concentration personnalisables.';
  ...
  String get onboarding_page_three_info =>
      'Comrade est 100% open-source et fonctionne entièrement hors ligne. Nous ne collectons ni ne partageons pas vos données personnelles — votre vie privée est garantie à tous les niveaux.';
  ...
  String get onboarding_page_permissions_info =>
      'Comrade a besoin des autorisations suivantes pour suivre et gérer votre temps d\'écran, vous aider à réduire les distractions et améliorer votre concentration.';
