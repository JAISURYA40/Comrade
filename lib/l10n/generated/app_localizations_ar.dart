...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get comrade_tagline => 'Focus on what truly Matters';
  ...
  String get permission_sheet_privacy_info =>
      'تطبيق Comrade آمن بنسبة ١٠٠% ويعمل دون اتصال بالإنترنت. ولا نقوم بجمع أو تخزين أي بيانات شخصية.';
  ...
  @override
  String get permission_grant_step_two => '٢. حدد Comrade في الشاشة التالية.';
  ...
  String get permission_alarms_info =>
      'يرجى منح الإذن لضبط التنبيهات والتذكيرات. سيسمح هذا لتطبيق Comrade ببدء جدول وقت النوم في الوقت المحدد وإعادة ضبط مؤقتات التطبيق يوميًا عند منتصف الليل ومساعدتك على البقاء على المسار الصحيح.';
  ...
  String get permission_usage_info =>
      'يرجى منح إذن الوصول إلى الاستخدام. سيسمح هذا لـ Comrade بمراقبة استخدام التطبيق وإدارة الوصول إلى تطبيقات معينة، مما يضمن بيئة رقمية أكثر تركيزًا وتحكمًا.';
  ...
  String get permission_overlay_info =>
      'يرجى منح إذن عرض التراكب. سيسمح هذا لتطبيق Comrade بعرض تراكب عند فتح تطبيق متوقف مؤقتًا، مما يساعدك على البقاء مركزًا والالتزام بجدولك الزمني.';
  ...
  String get permission_accessibility_info =>
      'يرجى منح إذن الوصول. سيسمح هذا لشركة Comrade بتقييد الوصول إلى محتوى الفيديو القصير (مثل Reels وShorts) داخل تطبيقات الوسائط الاجتماعية والمتصفحات، وتصفية المواقع الإلكترونية غير المناسبة.';

  @override
  String get permission_accessibility_required =>
      'يتطلب تطبيق Comrade إذن الوصول لتفعيل حظر المحتوى القصير والمواقع الإلكترونية بفعالية.';

  @override
  String get permission_accessibility_device_tile_label => 'استخدم Comrade';
  ...
  String get permission_dnd_info =>
      'يرجى منح ميزة \"عدم الإزعاج\" حق الوصول. سيسمح هذا لتطبيق Comrade ببدء وإيقاف وضع \"عدم الإزعاج\" أثناء جدول وقت النوم.';
  ...
  String get permission_vpn_info =>
      'يرجى منح الإذن لإنشاء اتصال بشبكة خاصة افتراضية (VPN). سيسمح هذا لـ Comrade بتقييد الوصول إلى الإنترنت للتطبيقات المحددة من خلال إنشاء شبكة VPN محلية على الجهاز.';
  ...
  String get permission_notification_access_info =>
      'يرجى منح إذن الوصول إلى الإشعارات. سيسمح هذا لـ Comrade بتنظيم إشعاراتك وتسليمها حسب جدولك.';

  @override
  String get permission_notification_access_required =>
      'يتطلب Comrade الوصول إلى الإشعارات للدفعات والإشعارات المجدولة.';
  ...
  String get development_dialog_info =>
      'تطبيق Comrade قيد التطوير حاليًا وقد يحتوي على أخطاء أو ميزات غير مكتملة. إذا واجهت أي مشكلات، فيرجى الإبلاغ عنها لمساعدتنا على التحسين.\n\nشكرًا لك على ملاحظاتك!';
  ...
  String get donation_card_info =>
      'Comrade هو تطبيق مجاني ومفتوح المصدر، تم تطويره بعد شهور من التفاني. إذا ساعدك التطبيق، فإن تبرعك يعني الكثير بالنسبة لنا. تساعدنا كل مساهمة في تحسينه وصيانته من أجل الجميع.';
  ...
  String get app_restart_dialog_info =>
      'سيتم إعادة تشغيل Comrade تلقائيًا بمجرد انتهاء العد التنازلي. يرجى التحلي بالصبر أثناء تطبيق التغييرات.';

  @override
  String get accessibility_tip =>
      'هل ترغب في حظر أذكى وأكثر توفيرا للطاقة؟ فعل إذن إمكانية الوصول لتطبيق Comrade.';

  @override
  String get battery_optimization_tip =>
      'هل لا يعمل تطبيق Comrade؟ اسمح بخيار \"تجاهل تحسين البطارية\" من الإعدادات ليعمل بسلاسة.';
  ...
  String get tamper_protection_tip =>
      'هل تنوي إزالة تطبيق Comrade؟ فعل نافذة إلغاء التثبيت لتعطيل حماية العبث بأمان أولا.';
  ...
  String get onboarding_page_one_info =>
      'قم بإيقاف التطبيقات المشتتة للانتباه مؤقتًا، وحظر المحتوى القصير، والتزم بالمسار الصحيح من خلال جلسات التركيز القابلة للتخصيص. سواء كنت تعمل أو تدرس أو تسترخي، يساعدك Comrade على البقاء متحكمًا.';
  ...
  String get onboarding_page_three_info =>
      'Comrade هو تطبيق مفتوح المصدر بنسبة ١٠٠% ويعمل دون اتصال بالإنترنت بالكامل. نحن لا نجمع أو نشارك بياناتك الشخصية — خصوصيتك مضمونة بكل الطرق.';
  ...
  String get onboarding_page_permissions_info =>
      'يتطلب Comrade اتباع الأذونات الأساسية لتتبع وإدارة وقت الشاشة، مما يساعد على تقليل عوامل التشتيت وتحسين التركيز.';
  ...
  String get protected_access_tile_subtitle =>
      'احمِ تطبيق Comrade بواسطة قفل جهازك.';
  ...
  String get tamper_protection_confirmation_dialog_info =>
      'بمجرد التفعيل، لن تتمكن من إلغاء التثبيت أو إيقاف التطبيق قسريا أو مسح بيانات Comrade، إلا خلال فترة إلغاء التثبيت المحددة. لا توجد حلول بديلة.\n\nتابع على مسؤوليتك الخاصة.';
  ...
  String get service_stopping_warning =>
      'إذا توقف تطبيق Comrade عن العمل فجأة، يرجى منح إذن \"تجاهل تحسين البطارية\" ليتمكن من العمل في الخلفية. إذا استمرت المشكلة، حاول إضافة Comrade إلى القائمة البيضاء لضمان أداء مستمر دون انقطاع.';

  @override
  String get whitelist_app_tile_title => 'أضف Comrade إلى القائمة البيضاء';

  @override
  String get whitelist_app_tile_subtitle =>
      'اسمح لتطبيق Comrade بالبدء التلقائي.';
  ...
  String get privacy_policy_info =>
      'تلتزم Comrade بحماية خصوصيتك. نحن لا نجمع أو نخزن أو ننقل أي نوع من بيانات المستخدم. يعمل التطبيق بالكامل دون اتصال بالإنترنت، مما يضمن بقاء معلوماتك الشخصية خاصة وآمنة على جهازك. كبرنامج مجاني ومفتوح المصدر (FOSS)، يضمن Comrade شفافية كاملة وتحكم المستخدم الكامل في بياناته.';
