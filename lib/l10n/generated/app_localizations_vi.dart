...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get comrade_tagline => 'Tập trung vào những gì thực sự quan trọng';
  ...
  String get permission_sheet_privacy_info =>
      'Comrade an toàn 100% và hoạt động ngoại tuyến. Chúng tôi không thu thập hoặc lưu trữ bất kỳ dữ liệu cá nhân nào.';
  ...
  String get permission_grant_step_two =>
      '2. Chọn Comrade ở màn hình tiếp theo.';
  ...
  String get permission_alarms_info =>
      'Vui lòng cấp quyền cài đặt báo thức và nhắc nhở. Điều này sẽ cho phép Comrade bắt đầu lịch trình đi ngủ đúng giờ và đặt lại bộ hẹn giờ ứng dụng hàng ngày vào lúc nửa đêm và giúp bạn duy trì đúng tiến độ.';
  ...
  @override
  String get permission_accessibility_device_tile_label => 'Sử dụng Comrade';
